...
![Пример отображения элементов в потоке по умолчанию без использования стилей](/flow/image1.png)

![Схематическое представление блочной модели (box model) в веб-дизайне](/flow/image12.png)
...
![Пример расчета итогового размера элемента с отступами и рамками](/flow/image4.png)

Еще примеры:

![Примеры работы с блочной моделью: внешний вид элементов с разными](/flow/image5.png)
...
![Подробная схема блочной модели с элементами: ширина, отступы, рамки, поля](/flow/image2.png)
...
![Иллюстрация расчета размера блока с учётом padding и margin](/flow/image3.png)
...
![Сравнение элементов с разными значениями свойства box-sizing: content-box и border-box](/flow/image6.png)
...
![Пример блочного элемента, занимающего всю ширину родительского контейнера](/flow/image7.png)
...
![Пример строчных элементов, которые размещаются в одну строку](/flow/image8.png)
...
![Пример строчных элементов с внешними и внутренними отступами, рамками](/flow/image9.png)
...
![Пример блочно-строчного элемента, сочетающего свойства блочных и строчных элементов](/flow/image10.png)

#### Флексы

`flex` — основной инструмент построения крупных сеток и микросеток.

![Пример использования flexbox для выравнивания и гибкой компоновки элементов](/flow/image11.png)
